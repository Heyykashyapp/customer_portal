    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="customers">
                    <a href="#customers">Customers</a>
                                ...
                                <a href="#customers-GETapi-customers">Display a listing of the customers.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-POSTapi-customers">
                                <a href="#customers-POSTapi-customers">Store a newly created customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-GETapi-customers--id-">
                                <a href="#customers-GETapi-customers--id-">Display the specified customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-PUTapi-customers--id-">
                                <a href="#customers-PUTapi-customers--id-">Update the specified customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-DELETEapi-customers--id-">
                                <a href="#customers-DELETEapi-customers--id-">Remove the specified customer.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-password-reset">POST api/password/reset</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-mfa-verify">
                                <a href="#endpoints-POSTapi-mfa-verify">POST api/mfa-verify</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="customers">Customers</h1>
                                ...
                                <h2 id="customers-GETapi-customers">Display a listing of the customers.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="customers-POSTapi-customers">Store a newly created customer.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The first name of the customer. Example: <code>John</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The last name of the customer. Example: <code>Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The email of the customer. Example: <code>john.doe@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>date</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="dob"                data-endpoint="POSTapi-customers"
               value="1985-01-01"
               data-component="body">
    <br>
<p>The date of birth of the customer. Example: <code>1985-01-01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="age"                data-endpoint="POSTapi-customers"
               value="36"
               data-component="body">
    <br>
<p>The age of the customer. Example: <code>36</code></p>
        </div>
        </form>

                    <h2 id="customers-GETapi-customers--id-">Display the specified customer.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/customers/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the customer. Example: <code>architecto</code></p>
                    ...
                    <h2 id="customers-PUTapi-customers--id-">Update the specified customer.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The first name of the customer. Example: <code>Jane</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>last_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The last name of the customer. Example: <code>Smith</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="kashyapp722@gmail.com"
               data-component="body">
    <br>
<p>The email of the customer. Example: <code>kashyapp722@gmail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>dob</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="dob"                data-endpoint="PUTapi-customers--id-"
               value="1990-05-15"
               data-component="body">
    <br>
<p>The date of birth of the customer. Example: <code>1990-05-15</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>age</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="age"                data-endpoint="PUTapi-customers--id-"
               value="31"
               data-component="body">
    <br>
<p>The age of the customer. Example: <code>31</code></p>
        </div>
        </form>

                    <h2 id="customers-DELETEapi-customers--id-">Remove the specified customer.</h2>
...
<p>Must be at least 6 characters. Example: <code>]|{+-0pBNvYg</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-mfa-verify">POST api/mfa-verify</h2>
...
<span id="example-requests-POSTapi-mfa-verify">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/mfa-verify" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-mfa-verify">
</span>
<span id="execution-results-POSTapi-mfa-verify" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-mfa-verify"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-mfa-verify"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-mfa-verify" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-mfa-verify">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-mfa-verify" data-method="POST"
      data-path="api/mfa-verify"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-mfa-verify', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-mfa-verify"
                    onclick="tryItOut('POSTapi-mfa-verify');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-mfa-verify"
                    onclick="cancelTryOut('POSTapi-mfa-verify');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-mfa-verify"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-mfa-verify"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-mfa-verify"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
